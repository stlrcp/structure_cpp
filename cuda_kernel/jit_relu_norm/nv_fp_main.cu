...
int main() {
    ...
    float *h_d2, *h_b2, *h_b1;
    h_d2 = (float *)malloc(nBytes);
    h_b1 = (float *)malloc(mBytes);
    h_b2 = (float *)malloc(mBytes);
    cudaMemcpy(h_d2, d_c, nBytes, cudaMemcpyDeviceToHost);
    cudaMemcpy(h_b1, d_b, nBytes, cudaMemcpyDeviceToHost);
    cudaMemcpy(h_b2, d_d, nBytes, cudaMemcpyDeviceToHost);
